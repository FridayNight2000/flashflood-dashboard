...
const StationPeakDistributionChart = forwardRef<
  SVGSVGElement,
  StationPeakDistributionChartProps
  ...
  return (
    ...
    >
      ...
      {chartData.points.map((point) => (
        <circle key={point.rank} cx={point.x} cy={point.y} r="2" fill="#0f766e">
