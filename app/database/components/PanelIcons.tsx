export function BasinBadgeIcon() {
  return (
    <svg
      aria-hidden="true"
      className="h-4 w-4 shrink-0 text-[#4288C9]"
      viewBox="0 0 24 24"
      fill="none"
...
export function StationBadgeIcon() {
  return (
    <svg
      aria-hidden="true"
      className="h-3.5 w-3.5 shrink-0 text-[#EF4444]"
      viewBox="0 0 432 432"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    >
...
export function CollapseChartsIcon() {
  return (
    <svg
      aria-hidden="true"
      className="h-9 w-9"
