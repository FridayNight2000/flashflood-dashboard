type SearchLoadingIconProps = {
  className?: string;
};

export default function SearchLoadingIcon({ className }: SearchLoadingIconProps) {
  const iconClassName = ['h-5 w-5 shrink-0 text-slate-400', className].filter(Boolean).join(' ');
