...
export default function AlgorithmPage() {
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <div className="mt-5 grid grid-cols-3 gap-3 font-['JetBrains_Mono'] text-[11px] leading-5">
            <div className="rounded-lg border border-sky-200 bg-sky-50 px-3 py-2.5 text-sky-800">
              <div className="text-xs whitespace-nowrap">
                <span className="font-semibold text-sky-600">Start:</span>
                {' ← water level crosses above P50'}
              </div>
            </div>
            <div className="rounded-lg border border-violet-200 bg-violet-50 px-3 py-2.5 text-violet-800">
              <div className="text-xs whitespace-nowrap">
                <span className="font-semibold text-violet-600">Peak:</span>
                {' ← highest point exceeding P75'}
              </div>
            </div>
            <div className="rounded-lg border border-rose-200 bg-rose-50 px-3 py-2.5 text-rose-800">
              <div className="text-xs whitespace-nowrap">
                <span className="font-semibold text-rose-600">End:</span>
  ...
  return (
    <div className="overflow-hidden bg-white font-['DM_Sans']">
      <link
        ...
        {sections.map((section) => (
          ...
          >
            ...
            {!section.last && (
              ...
              >
                <div className={`flex flex-col items-center ${section.accentClass}`}>
